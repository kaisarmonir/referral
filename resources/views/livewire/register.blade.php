            ...
            <div class="card-header">
              ...
              <form action="{{route('register')}}" method="post">
                ...
                @enderror
                    ...
                    <input type="text" class="form-control" id="referCode" name="referCode" placeholder="Enter refer code" value="{{old('referCode')}}" required>
                  </div>
               ...
               <div class="card-footer">
                  ...
                  <span class="code d-none" style="cursor:pointer; margin-left:6px">use 1 as refer code</span>
                </div>
              </form>
            </div>
        </div>
